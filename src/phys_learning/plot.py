...
def histOne(x1, bins, range, name, xlabel, ylabel='Count'):
    fig, ax = plt.subplots()
...
def histTwo(x1, x2, bins, range, name, xlabel, ylabel='Count',
            label1='1', label2='2'):
    fig, ax = plt.subplots()
...
def plotOne(x1, y1, name, xlabel, ylabel='Count'):
    fig, ax = plt.subplots()
...
def plotTwo(x1, y1, x2, y2, name, xlabel, ylabel='Count',
            label1='1', label2='2'):
    fig, ax = plt.subplots()
